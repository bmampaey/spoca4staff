...
start_date = datetime(2020,9,9,0,0)
...
spoca_ar_config = "/data/STAFF/AIA/AIA_AR.segmentation.config"

# Wavelengths for spoca_ar
spoca_ar_wavelengths = [171, 193]

# Directory to output the CH maps
ARmaps_directory = "/data/STAFF/AIA/AR_segmentation/"
...
spoca_ch_config = "/data/STAFF/AIA/AIA_CH.segmentation.config"

# Wavelengths for spoca_ch
spoca_ch_wavelengths = [193]

# Directory to output the AR maps
CHmaps_directory = "/data/STAFF/AIA/CH_segmentation/"
